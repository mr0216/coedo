...
## アプリケーション概要
埼玉県川越市の観光スポット、ショップ、イベントを共有するアプリケーションです。<br>投稿するのは事業者様、一般の方はログインせずに閲覧することが可能です。

## 制作背景
前職は川越市の商業施設で勤務してたことで、地元の店舗の方々と交流する機会がありました。<br>アピールする媒体が個々のHPやSNSなので、「webアプリケーション」という一つの括りでアピールをするプラットフォームを作りたいと考えたことがきっかけで作成しました。
...
## 目指した課題解決
+ 店舗や観光地の事業者様は情報の周知を広げたいが、自店のHPやSNSのみで情報が周知されない
